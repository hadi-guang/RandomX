 ...
 */
static void p_hex(const char *prefix_str, const void *buf, size_t len)
{
	print_hex_dump(prefix_str, DUMP_PREFIX_OFFSET, 16, 1,
		       buf, len, true);
}
static void p_hex8(const char *prefix_str, const void *buf, size_t len)
{
	print_hex_dump(prefix_str, DUMP_PREFIX_OFFSET, 16, 8,
		       buf, len, true);
}
